...
Examples:
    init_skill.py my-new-skill --path .claude
    init_skill.py my-api-helper --path .claude
...
def main():
    if len(sys.argv) < 4 or sys.argv[2] != '--path':
        ...
        print("\nExamples:")
        print("  init_skill.py my-new-skill --path .claude")
        print("  init_skill.py my-api-helper --path .claude")
